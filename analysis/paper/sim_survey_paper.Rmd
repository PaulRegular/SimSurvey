...
- As with any population monitoring program, accurate and reliable results from a fisheries-independent trawl survey depends on good survey design. Ideally, the sampling design of large and costly surveys should be simulation tested before embarking on an expensive field program.

- While there are several simulation frameworks for testing the design of fisheries-independent trawl surveys [e.g. @puerta2019; @schnute2003], there are few tools that facilitate such work. Here we document an R package with a series of functions for testing the multi-layered sampling design of spatial, age-structured populations. The package can also serve as a medium for the simulation testing of methods for analyzing such data.


It is well known that the accuracy and reliability of any population monitoring program hinges on good survey design and analysis. Ideally, the design and analysis of any large and costly survey should be simulation tested before embarking on expensive field programs. This is especially true for the large-scale and costly fisheries-independent trawl surveys conducted by numurous regional fisheries management organizations. These surveys have become an increasingly important research tool for the management of dynamic fish stocks as they provide indices of population abundance as well as estimates of various population characteristics such as length and age frequencies [@Pennington1998]. While costly to obtain, this information forms the basis of of many stock assessments used throughout the world. Efficient, effective and informed management decisions therefore require surveys and analyses that maximize information while minimizing the expense of data collection. Solving this optimization problem is not a trivial task given the complexity of the population processes we aim to represent and the multi-stage nature of the typical sampling program.

The complexity of the system and the surveys may be why simulation tests of the full sampling and analylicical pathway are rare. Simulations provide a playground of sorts...multiple frameworks...few accessible...

Fisheries-independent trawl surveys have become an increasingly important research tool for the management of dynamic fish stocks. These surveys provide indices of population abundance as well as estimates of various population characteristics such as length and age frequencies [@Pennington1998]. While costly to obtain, this information forms the basis of of many stock assessments models used throughout the world. Effective and informed management decisions therefore require surveys that maximize information while minimizing the expense of data collection. Determining the number of samples required to adequately characterize a fish population is particularly challenging since data tend to be collected across one or more stages [@Aanes2015]. Optimal survey design is further complicated by the fact that trawls sample clusters of fish that tend to have similar characteristics, such as length and age. This phenomenon results in samples with positive intra-haul correlation, which can markedly reduce the effective sample size for estimating length and age frequencies of the target population [@Pennington1994; @Pennington2002; @Stewart2014]. The complexities of multi-stage sampling and intra-haul correlation make it difficult to answer the question *"how much sampling is enough?"* Moreover, the answer to this question is inextricably linked with the way in witch these data are analyzed.

While analyses of fisheries-independent survey data has typically been confined to design-based approaches [e.g. stratified-random survey data tend to be analyzed using standard stratified-analysis formulae;  @Cochran1977], there are a growing number of model-based approaches for analyzing such data [e.g. @smith1990; @Berg2014; @Thorson2015]. The merits of both approaches have long been debated, however, simulation tests of the full sampling and analylitical pathway are rarely conducted. This is especially true for design- or model-based estimates of abundance-at-age, which is a criticial input to any age-based stock assessment model. Ideally, the design and analysis of any large and costly survey should be simulation tested before embarking on an expensive field program.
...
- Dave Cote, Keith Lewis and Greg Robertson for a review of a previous version of this manuscript
