...
Though some typical relationships have yet to be implemented (e.g. stock-recruitment), this formulation facilitates the simulation of age-structured populations that are dynamic enough to test an array of survey designs.
...
| `+                   strat_splits = 2,`                 | Number of times to horizontally split strat                  | &nbsp;                                  |
