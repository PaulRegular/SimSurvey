...
| `+  ages = 1:20,`                           | Ages                                                       | $a$                                 |
| `+  years = 1:20,`                          | Years                                                      | $y$                                 |
| `+  R = sim_R(log_mean = log(30000000),`    | Mean log recruitment^1^                                    | $\mu_r$                             |
| `+            log_sd = 0.5),`               | Standard deviation of log recruitment                      | $\sigma_r$                          |
| `+  Z = sim_Z(log_mean = log(0.5),`         | Mean log total mortality ^2^                               | $\mu_Z$                             |
| `+            log_sd = 0.2,`                | Standard deviation of log total mortality                  | $\sigma_Z$                          |
...
if (is_html) {
  ...
  knitr::include_graphics(here("analysis", "paper", "figures", "plot_total_strat_fan.png"))
}
...
if (is_html) {
  ...
  knitr::include_graphics(here("analysis", "paper", "figures", "plot_length_strat_fan.png"))
}
...
if (is_html) {
  ...
  knitr::include_graphics(here("analysis", "paper", "figures", "plot_age_strat_fan.png"))
}
...
if (is_html) {
  ...
  knitr::include_graphics(here("analysis", "paper", "figures", "plot_survey_rank.png"))
}
...
if (is_html) {
  ...
  knitr::include_graphics(here("analysis", "paper", "figures", "alt_tests_plots.png"))
}
