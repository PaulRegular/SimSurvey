...
Unlike the default approach to collecting and analyzing age samples, results from this test conform to expectations in that the estimator appears to be unbiased and, ignoring the costs associated with unnecessary sampling effort, there appears to be no negative consequences of increasing sub-sampling effort (Figure \@ref(fig:alt)). This is an important result with real-world implications for the survey the case study is based on. This example shows how **`SimSurvey`** can be used to reveal problems and explore solutions to the sampling designs of fisheries-independent surveys.
