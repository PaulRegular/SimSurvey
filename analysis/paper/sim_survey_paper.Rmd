...
# Things to manually fix in word

1. Adjust font size of code strings
2. Decrease font size of tables
3. Indent closures in Table \@ref(tab:fun)
4. Replace pluses (`+`) with spaces in Tables \@ref(tab:abundance) to (\#tab:survey)
5. Adjust size of footnote below Table \@ref(tab:abundance)
6. Adjust size of Figure \@ref(fig:real-sim-comp)
