...
*We really struggled to accommodate a traditional Methods and Results section as any structure we attempted betrayed the definition of these sections. ----DESCRIBE WHAT WE DID HERE----. Below we discuss a couple of failed attempts:*

*1) We tried to start the methods section with the "Model Structure" section, as suggested, and shunt the figures to a "Results" section; this, however, broke the flow and left a gap in the methods section where we show the methods (functions) for running a simulation but do not show the plotting methods.*

*2) We tried to keep the methods section as is (i.e. describe equations and functions) and describe some of the key case study results in the results section, but it was difficult to find a logical placement for the "Parameterisation" section and it did not seem right to segue to a solution to a problem identified in the case study in a traditional results section. In contrast, it seemed fine to describe and discuss the case study results demonstrated through the "Core functions" section and then jump to a solution to a problem in an independent section.*
