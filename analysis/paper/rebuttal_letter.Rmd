...
*Thank you for thinking beyond a fisheries biologist audience, as this is the audience we have been targeting from the onset. In case this is short-sighted, we have modified our introduction, as suggested, to pitch the concept to a broader audience. The reason we did not think about other biologists is because fisheries biologist tend to have access to age-based data while others (e.g. seabird and caribou biologists) do not. Alas, we agree that there could be biologists outside the field of fisheries that have such data or stage-based data who may find the package useful; if nothing else, the general framework may be useful to adapt to other marine or terrestrial situations.*
