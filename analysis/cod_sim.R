...
base_case <- sim_survey_parallel(pop, n_sims = 5, n_loops = 200, cores = 6,
...
fwrite(setdet, file = "analysis/cod_sim_exports/2018-09-10_for_Geoff/01_setdet.csv")
fwrite(samp, file = "analysis/cod_sim_exports/2018-09-10_for_Geoff/01_samp.csv")
rm(base_case)
gc()

## One example of a protocol that results in bias
bias_case <- sim_survey_parallel(pop, n_sims = 1, n_loops = 1000, cores = 6,
...
samp$measured <- samp$aged <- NULL
samp <- merge(setdet[, list(year, sim, set)], samp, by = "set")
fwrite(setdet, file = "analysis/cod_sim_exports/2018-09-10_for_Geoff/02_setdet.csv")
fwrite(samp, file = "analysis/cod_sim_exports/2018-09-10_for_Geoff/02_samp.csv")
rm(bias_case)
gc()
