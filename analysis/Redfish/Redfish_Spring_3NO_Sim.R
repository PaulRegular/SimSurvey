# Simulate Spring 3NO Redfish population
## See "Imitate_Redfish_spring_3NO.R" file for details on parameter choices
# #-------------------------------------------------
...
###------------------------------
setwd("~//SimSurvey-doc/Jan21/Sim-export/Redfish/Spring")
library(SimSurvey)
set.seed(794)
