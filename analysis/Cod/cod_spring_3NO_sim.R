# Simulate Spring 3NO cod population
## See "imitate_cod_spring_3NO.R" file for details on parameter choices
...
surveys[surveys$set_den == 0.001 &
          ...
          surveys$ages_cap == 10, ]    ## survey 23 ~current protocol
sim <- test_surveys(pop,
                    ...
                    export_dir = "analysis/sim_exports/cod_sim_exports/2021-03-12_age_clust_test")

# sim <- resume_test(export_dir = "analysis/cod_sim_exports/2018-10-26_age_clust_test")


## Visualize Results
load("analysis/sim_exports/cod_sim_exports/2021-03-12_age_clust_test/test_output.RData")
...
sim <- test_surveys(pop,
                    ...
                    cores = 7,
                    q = sim_logistic(k = 1.8, x0 = 2.4),
                    export_dir = "analysis/sim_exports/cod_sim_exports/2021-03-11_set_alk",
                    age_length_group = 2,
                    age_space_group = "set",
                    alk_scale = "set")
