...
system.time(pop <- sim_abundance(ages = 1:26,
                     years = 1:24,
                     R = sim_R(log_mean = log(15000000),
                               log_sd = 0.5,
                               random_walk = TRUE),
                     Z = sim_Z(log_mean = log(0.17),
                               log_sd = 0.5,
                               phi_age = 0.9,
                               phi_year = 0.5),
  ...
  sim_distribution(grid,
                   ays_covar = sim_ays_covar(sd = 4.5,
                                             ...
                                             phi_year = 0.5),
                                             #group_ages = 8:26),
                   depth_par = sim_parabola(mu = log(80),  #increase mu for catch and depth in simulated data
                                            sigma = 0.25,
                                            sigma_right = 0.8, log_space = TRUE)))
