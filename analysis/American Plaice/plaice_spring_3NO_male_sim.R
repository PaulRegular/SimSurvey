# Simulate Spring 3NO male plaice population
## See "imitate_plaice_spring_3NO_male.R" file for details on parameter choices
...
sim <- test_surveys(pop,
                    ...
                    export_dir = "analysis/sim_exports/plaice_male_sim_exports/2021-02-19_age_clust_test")

# sim <- resume_test(export_dir = "analysis/cod_sim_exports/2018-10-26_age_clust_test")


## Visualize Results
load("analysis/sim_exports/plaice_male_sim_exports/2021-02-19_age_clust_test/test_output.RData")
...
## Visualize Results
load("analysis/sim_exports/plaice_male_sim_exports/2021-02-21_set_alk/test_output.RData")
