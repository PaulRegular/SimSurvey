# Simulate Spring 3NO female plaice population
...
pop <- sim_abundance(ages = 1:16,
                     years = 1:20,
                     R = sim_R(log_mean = log(170000000),
                               log_sd = 0.7,
                               random_walk = FALSE),
                     Z = sim_Z(log_mean = log(0.28),
                               log_sd = 0.7,
                               phi_age = 0.7,
                               phi_year = 0.7),
  ...
  sim_distribution(make_grid(x_range = c(-184, 184),
                             y_range = c(-184, 184),
                             res = c(3.5, 3.5),
                             shelf_depth = 60,
                             shelf_width = 170,
...
sim <- test_surveys(pop,
                    ...
                    export_dir = "C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_male_sim_exports/2021-02-19_age_clust_test")

# sim <- resume_test(export_dir = "analysis/cod_sim_exports/2018-10-26_age_clust_test")


## Visualize Results
load("C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_male_sim_exports/2021-02-19_age_clust_test/test_output.RData")

plot_total_strat_fan(sim)
plot_length_strat_fan(sim, surveys = 1:75, years = 1:20, lengths = 0.5:144.5)
plot_age_strat_fan(sim, surveys = 1:75, years = 10, ages = 1:16)
...
sim <- test_surveys(pop,
                    ...
                    cores = 7,
                    q = sim_logistic(k = 1.4, x0 = 4),
                    export_dir = "C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_male_sim_exports/2021-02-21_set_alk",
                    age_length_group = 2,
                    age_space_group = "set",
                    alk_scale = "set")
...
## Visualize Results
load("C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_male_sim_exports/2021-02-21_set_alk/test_output.RData")
...
### NOT CURRENTLY USING SIMS BELOW
