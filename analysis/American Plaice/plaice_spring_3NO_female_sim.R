...
## See "imitate_plaice_spring_3NO_female.R" file for details on parameter choices
...
sim <- test_surveys(pop,
                    ...
                    export_dir = "analysis/sim_exports/plaice_female_sim_exports/2021-01-22_age_clust_test")

# sim <- resume_test(export_dir = "analysis/cod_sim_exports/2018-10-26_age_clust_test")


## Visualize Results
load("analysis/sim_exports/plaice_female_sim_exports/2021-01-22_age_clust_test/test_output.RData")
...
sim <- test_surveys(pop,
                    ...
                    cores = 7,
                    q = sim_logistic(k = 5, x0 = 2),
                    export_dir = "analysis/sim_exports/plaice_female_sim_exports/2021-01-24_set_alk",
                    age_length_group = 2,
                    age_space_group = "set",
                    alk_scale = "set")
