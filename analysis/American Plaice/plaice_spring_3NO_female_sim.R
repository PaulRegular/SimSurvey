...
pop <- sim_abundance(ages = 1:24,
                     years = 1:20,
                     R = sim_R(log_mean = log(55000000),
                               log_sd = 0.5,
                               random_walk = FALSE),
                     Z = sim_Z(log_mean = log(0.07),
                               log_sd = 0.8,
                               phi_age = 0.8,
                               phi_year = 0.7),
...
sim <- test_surveys(pop,
                    ...
                    n_loops = 200,
                    cores = 7,
                    q = sim_logistic(k = 5, x0 = 2),
                    export_dir = "C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_female_sim_exports/2021-01-22_age_clust_test")

# sim <- resume_test(export_dir = "analysis/cod_sim_exports/2018-10-26_age_clust_test")


## Visualize Results
load("C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_female_sim_exports/2021-01-22_age_clust_test/test_output.RData")

plot_total_strat_fan(sim)
plot_length_strat_fan(sim, surveys = 1:75, years = 1:20, lengths = 0.5:144.5)
plot_age_strat_fan(sim, surveys = 1:75, years = 10, ages = 1:24)
...
sim <- test_surveys(pop,
                    ...
                    cores = 7,
                    q = sim_logistic(k = 5, x0 = 2),
                    export_dir = "C:/Users/FITZSIMMONSM/Documents/SimSurvey/SimSurvey/analysis/plaice_female_sim_exports/2021-01-24_set_alk",
                    age_length_group = 2,
                    age_space_group = "set",
                    alk_scale = "set")
